...
export class CompileData {
    ...
    initWool() {
        ...
        for (let color in COLOR_PALETTE) {
            ...
            const b = {
                ...
                tags: ['wool', 'can_put_into_pot', 'mask_color'],
            };
            this.blocks.push(b);
            i++;
        }
    ...
    initButtons() {
        ...
        for (let mat of materials) {
            ...
            const b = {
                ...
                tags: ['no_drop_ao', 'rotate_by_pos_n_12', 'button'],
    ...
    initBed() {
        ...
        for (let color in COLOR_PALETTE) {
            ...
            const b = {
                ...
                tags: ['bed', 'rotate_by_pos_n', 'mask_color'],
            };
            this.blocks.push(b);
            i++;
        }
    ...
    initTerracotta() {
        ...
        for (let color in COLOR_PALETTE) {
            ...
            const b = {
                ...
                mask_color: mask_color,
                tags: ['can_put_into_pot', 'mask_color'],
            };
            this.blocks.push(b);
        }
        //
    ...
    initCarpets() {
        ...
        for (let color in COLOR_PALETTE) {
            ...
            const b = {
                ...
                texture: { side: 'block/white_wool.png' },
                mask_color: mask_color,
                tags: ['mask_color', 'carpet', 'rotate_by_pos_n', 'no_drop_ao'],
                support_style: 'item_frame',
            };
            this.blocks.push(b);
            i++;
        ...
        for (let egg of eggs) {
            ...
            const b = {
                ...
                compile: {
                    ...
                    layers: [
                        {
                            image: 'item/spawn_egg_overlay.png',
                            overlay_color: color.overlay,
                        },
                    ],
                },
                texture: {
    ...
    initPressurePlate() {
        const plates = [
            ...
            },
            {
                ...
                texture: 'block/polished_blackstone.png',
                material: 'stone',
            },
            {
                id: 583,
                name: 'LIGHT_WEIGHTED',
                texture: 'block/gold_block.png',
                material: 'stone',
            },
            {
                id: 585,
                name: 'HEAVY_WEIGHTED',
                texture: 'block/iron_block.png',
                material: 'stone',
            },
            {
                id: 587,
                name: 'SPRUCE',
                texture: 'block/spruce_planks.png',
                material: 'wood',
            },
            {
                id: 589,
                name: 'BIRCH',
                texture: 'block/birch_planks.png',
                material: 'wood',
            },
            {
                id: 591,
                name: 'JUNGLE',
                texture: 'block/jungle_planks.png',
                material: 'wood',
            },
            {
                id: 619,
                name: 'ACACIA',
                texture: 'block/acacia_planks.png',
                material: 'wood',
            },
            {
                id: 994,
                name: 'DARK_OAK',
                texture: 'block/dark_oak_planks.png',
                material: 'wood',
            },
            {
                id: 996,
                name: 'CRIMSON',
                texture: 'block/crimson_planks.png',
                material: 'wood',
            },
            {
                id: 74,
                name: 'WARPED',
                texture: 'block/warped_planks.png',
                material: 'wood',
            },
        ];
        ...
        for (let p of plates) {
            this.blocks.push({
                ...
                tags: ['set_only_fullface', 'no_drop_ao'],
    ...
    initBanner() {
        ...
        for (let color in COLOR_PALETTE) {
            ...
            const b = {
                ...
                inventory: {
                    scale: 0.75,
                    rotate: { x: 0, y: 0, z: Math.PI * 0.9 },
                    move: { x: 0, y: 0, z: 0.5 },
                },
                tags: ['banner', 'no_drop_ao', 'rotate_x16', 'mask_color'],
            };
            this.blocks.push(b);
            i++;
        }
    ...
    initSlope() {
        ...
        const PALETTE = [
            ...
            { name: 'WARPED', texture: `block/warped_planks.png` },
            {
                ...
                texture: `block/stripped_oak_log.png`,
            },
            {
                name: 'STRIPPED_BIRCH_WOOD',
                texture: `block/stripped_birch_log.png`,
            },
            {
                name: 'STRIPPED_ACACIA_WOOD',
                texture: `block/stripped_acacia_log.png`,
            },
            {
                name: 'STRIPPED_SPRUCE_WOOD',
                texture: `block/stripped_spruce_log.png`,
            },
            {
                name: 'STRIPPED_DARK_OAK_WOOD',
                texture: `block/stripped_dark_oak_log.png`,
            },
            {
                name: 'STRIPPED_JUNGLE_WOOD',
                texture: `block/stripped_jungle_log.png`,
            },
            {
                name: 'STRIPPED_WARPED_WOOD',
                texture: `block/stripped_warped_stem.png`,
            },
            {
                name: 'HAY',
                texture: {
            ...
            {
                name: 'MOSS_STONE',
                texture: 'block/mossy_cobblestone.png',
                sound: 'madcraft:block.stone',
                material: { id: 'stone' },
            },
            {
                name: 'MOSS_BLOCK',
                texture: './textures/moss_block.png',
                sound: 'madcraft:block.grass',
                material: { id: 'cobblestone' },
            },
            {
                name: 'COBBLESTONE',
                texture: 'block/cobblestone.png',
                sound: 'madcraft:block.stone',
                material: { id: 'stone' },
            },
        ];
        ...
        const FURNITURE_MATERIALS = [
            {
                prefix: 'BIRCH',
                log: 'birch_log',
                texture: 'block/birch_log_top.png',
            },
            { prefix: 'OAK', log: 'oak_log', texture: 'block/oak_log_top.png' },
            {
                prefix: 'ACACIA',
                log: 'acacia_log',
                texture: 'block/acacia_log_top.png',
            },
            {
                prefix: 'SPRUCE',
                log: 'spruce_log',
                texture: 'block/spruce_log_top.png',
            },
            {
                prefix: 'DARK_OAK',
                log: 'dark_oak_log',
                texture: 'block/dark_oak_log_top.png',
            },
            {
                prefix: 'JUNGLE',
                log: 'jungle_log',
                texture: 'block/jungle_log_top.png',
            },
            {
                prefix: 'CRIMSON',
                log: 'crimson_stem',
                texture: 'block/crimson_stem_top.png',
            },
            {
                prefix: 'WARPED',
                log: 'warped_stem',
                texture: 'block/warped_stem_top.png',
            },
        ];
    ...
    inherit(dstBlock, srcBlockName) {
        ...
        if (!srcBlock) {
            throw new Error(
                `Id=${dstBlock.id} "${dstBlock.name}" can't inherit from non-existing block "${srcBlockName}"`,
            );
        }
