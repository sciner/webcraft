...
export class WorldEditBuilding {
    ...
    async save(chat, player, cmd, args) {
        ...
        building.size = new Vector(
            copy_data.quboid.volx,
            copy_data.quboid.voly,
            copy_data.quboid.volz,
        );
    ...
    goToBuilding(chat, player, cmd, args) {
        ...
        const pos = new Vector(building.world.entrance.x + 0.5, 1, 4.5);
