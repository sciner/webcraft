...
export class DBWorldMigration {
    ...
    async apply() {
        let version = 0;
        // Read options
        const table_exists = await this.db.get(
        ...
        migrations.push({
            version: 12,
            queries: [
                `alter table drop_item add column "is_deleted" integer DEFAULT 0`,
            ],
        });
        migrations.push({
            version: 13,
            queries: [
                `alter table user add column "game_mode" TEXT DEFAULT NULL`,
            ],
        });
        migrations.push({
            version: 14,
            queries: [
                `UPDATE user SET inventory = replace(inventory, '"index2":0', '"index2":-1')`,
            ],
        });
        migrations.push({
            version: 15,
            queries: [
                `UPDATE entity SET x = json_extract(pos_spawn, '$.x'), y = json_extract(pos_spawn, '$.y'), z = json_extract(pos_spawn, '$.z')`,
            ],
        });
        migrations.push({
            version: 16,
        ...
        migrations.push({
            version: 17,
            queries: [
                `alter table world_modify add column "ticks" INTEGER DEFAULT NULL`,
            ],
        });
        migrations.push({
            version: 18,
            queries: [
                `UPDATE world_modify SET params = '{"id":612}' WHERE params = '{"id":141}';`,
            ],
        });
        migrations.push({
            version: 19,
            queries: [
                `UPDATE world_modify SET extra_data = '{"stage":0}' WHERE params = '{"id":59}' OR params LIKE '{"id":59,%';`,
            ],
        });
        migrations.push({
            version: 20,
        ...
        migrations.push({
            version: 22,
            queries: [
                `alter table world add column "add_time" INTEGER DEFAULT 7000`,
            ],
        });
        migrations.push({
            version: 23,
        ...
        migrations.push({
            version: 29,
            queries: [
                `alter table user_quest add column "is_completed" integer NOT NULL DEFAULT 0`,
            ],
        });
        migrations.push({
            version: 30,
        ...
        migrations.push({
            version: 31,
            queries: [
                `alter table user_quest add column "in_progress" integer NOT NULL DEFAULT 0`,
            ],
        });
        ...
        migrations.push({
            version: 36,
            queries: [`DELETE FROM entity;`, `DELETE FROM chunk;`],
        });
        migrations.push({
            version: 37,
            queries: [
        ...
        migrations.push({
            version: 53,
            queries: ['ALTER TABLE entity ADD COLUMN extra_data text'],
        });

        migrations.push({
            version: 54,
            queries: ['DELETE FROM world_modify WHERE block_id = 105'],
        });
        ...
        migrations.push({
            version: 60,
            queries: [`DELETE FROM world_modify WHERE block_id IN(104)`],
        });
        ...
        migrations.push({
            version: 66,
            queries: [`DELETE FROM world_modify WHERE block_id = 112;`],
        });
        ...
        this.db.run(
            `CREATE TEMPORARY TABLE IF NOT EXISTS world_modify_import_bulk(data TEXT);`,
        );
    }
}
