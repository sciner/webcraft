...
import { BACK_NEIGHBOUR_BY_DIRECTION, ChestHelpers, RIGHT_NEIGHBOUR_BY_DIRECTION } from "@client/block_helpers.js";
    ...
    onNeighbourChanged(tblock : TBlock, neighbour : TBlock, previous_neighbour : IBlockItem): void {
        ...
        if(neighbour_destroyed) {
            ...
            if (bm.SNOW.id == tblock.id  && neighbourPos.y < pos.y) {
                ...
                const dir = BACK_NEIGHBOUR_BY_DIRECTION[tblock.rotate.x]
