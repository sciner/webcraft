...
// TODO renderStart and renderFinish - perhaps just make them instructions to fit the arcitecture of the
// rest of the system
export class UniformBatchPipe implements InstructionGenerator
{
    /** @ignore */
    ...
    hash: Record<number, BindGroup> = {};
    batchBuffer: UniformBufferBatch;

    // number of buffers..
    buffers: Buffer[] = [];

    bindGroups: BindGroup[] = [];
    bufferResources: BufferResource[] = [];
