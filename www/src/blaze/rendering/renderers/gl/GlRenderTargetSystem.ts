...
export class GlRenderTargetSystem implements ISystem
{
    ...
    gpuRenderTargetHash: Record<number, GlRenderTarget> = {};
    ...
    defaultClearColor: RGBAArray = [0, 0, 0, 0];
    clearColorCache: RGBAArray = [0, 0, 0, 0];
    ...
    push(renderSurface: RenderTarget, clear = true, clearColor?: RGBAArray)
    {
    ...
    initGpuRenderTarget(renderTarget: RenderTarget)
    {
    ...
    initColor(renderTarget: RenderTarget, glRenderTarget: GlRenderTarget)
    {
        const renderer = this.renderer;
    ...
    resizeColor(renderTarget: RenderTarget, glRenderTarget: GlRenderTarget)
    {
    ...
    initStencil(glRenderTarget: GlRenderTarget)
    {
        const gl = this.renderer.gl;
    ...
    resizeStencil(glRenderTarget: GlRenderTarget)
    {
        const gl = this.renderer.gl;
