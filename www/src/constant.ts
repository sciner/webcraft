...
export enum SERVER_WORLD_WORKER_MESSAGE {
    ...
    no_need_to_unload = "no_need_to_unload",
    ...
    change_world_is_public = "change_world_is_public",
}
...
export enum BLOCK_SUPPORT_STYLE {
    BOTTOM              = 'bottom',
    CACTUS              = 'cactus',
    CANDLE              = 'candle',
    CHEST               = 'chest',
    ...
    RAILS               = 'rails',
    REDSTONE            = 'redstone',
    SANDED_STONES       = 'sanded_stones',
    SIGN                = 'sign',
    SKULL_DESERT        = 'skull_desert',
    SMALL_CACTUS        = 'small_cactus',
    SMALL_STONE_DESERT  = 'small_stone_desert',
    TORCH               = 'torch',
    UNCERTAIN_STONE     = 'uncertain_stone',
}