...
export class BaseResourcePack {
    ...
    // pushVertices
    pushVertices(vertices, block, world, x, y, z, neighbours, biome, dirt_color, draw_style, force_tex, _matrix, _pivot) {
        ...
        return module.func(block, vertices, world, x, y, z, neighbours, biome, dirt_color, true, _matrix, _pivot, force_tex);
    }
